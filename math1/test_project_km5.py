...
class TestProjectKM5(unittest.TestCase):
    ...
    def test_segment_4d(self):
        # 4D path with 3 segments
        self.assertEqual(
            segment_distances(
                [
                    [0, 0, 0, 0],
    ...
    def test_alternating_values(self):
        # Window of 3 with alternating values
        self.assertEqual(
            window_sums([5, -5, 5, -5, 5, -5], 3),
            [5, -5, 5, -5],
        )

    def test_varied_pos_and_neg_numbers(self):
        # Window of 3 with varied positive and negative values
        self.assertEqual(
            window_sums([3, -2, 7, -5, 4], 3),
            [8, 0, 6],
        )
    ...
    def test_disjointed_lists(self):
    ...
    def test_correct_round_up(self):
